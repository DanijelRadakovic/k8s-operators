#let custom-orange = rgb("#FF8C00")
#let custom-charcoal = rgb("#1A1A1A")
#let custom-white = rgb("#F2F2F2")
...
#let slides(
  ...
  // Colors
  let title-color = custom-orange
  let bg-color = custom-charcoal
  let block-color = custom-charcoal.lighten(10%)
  let body-color = custom-white
  let header-color = custom-orange
  ...
  show terms.item: it => {
    ...
    stack(
      block(fill: header-color, radius: (top: 0.2em, bottom: 0cm), text(fill: bg-color, strong(it.term))),
